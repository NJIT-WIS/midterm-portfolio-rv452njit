...
export default function Projects1({
  ...
  return (
    <section className='Section-Setting' id='Project1Section'>
        <main className="">
      
        <h2 style={{color: '#B0A32D'}} id="Project2">Trade Management</h2>
                ...
                <ul className="ul-setting list-setting a">
                    <li>
                        Project Role: Architect, Design, Develop Web-based solution for Trade Management
                    </li>  
                    <li>
                        Period: September 2020 - August 2023    
                    </li>            
                    <li>
                        Technologies: Angular, Type Script, Redux    
                    </li> 
                    <li>
                        Description: Architect Design and develop web based application
                    </li>
            </ul>
    </main>
    </section>   
