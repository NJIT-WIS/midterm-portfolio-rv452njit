...
export default function CurrentProjects({
    ...
    return (
        <section className='Section-Setting' id='CurrentProjectsSection'>
            <main className="">
                <h2 style={{color: '#B0A32D'}}>Profile Management</h2>
                {/* <div style={{ display: "flex", justifyContent: "space-around", fontSize: "36px" }}>Current Project</div> */}
                <ul className="ul-setting list-setting a">
                    <li>
                        Project Role: Architect, Design, Develop Web-based solutions
                    </li>  
                    <li>
                        Period: September 2023 - Present    
                    </li>            
                    <li>
                        Technologies: Nextjs, Figma, React, Bootstrap    
                    </li> 
                    <li>
                        Description: Architect Design and develop web based application, for profile management and liaison management with employers and organization
                    </li>
            </ul>
                {/* <div className="flex min-home-screen justify-center lg:flex-row">
